...
export default class ProductTileList extends LightningElement {
   ...
   // @track getProducts;
     ...
     */
   @wire(getProducts, { filters: '$filters', pageNumber: '$pageNumber' , pageSizeparam: '$pageSize'})
   products;
    ...
    handlePageSize(event) {
        if(!event.detail)  this.pageSize =0; else  this.pageSize = event.detail; 
       // console.log('pagesize'+ this.pageSize)
      //  console.log('products@@'+ JSON.stringify(this.getProducts.data.records.length));
      //  if( !this.pageSize !=0) refreshApex(this.getProducts);
        // console.log('products@@'+ JSON.stringify(this.getProducts.data.records.length));
